...
const Remedios = () => {
  ...
  const initialRemedios: Remedio[] = [
    { id: 1, nome: t("remedios.pressure"), horario: "08:00", tomado: false },
    { id: 2, nome: t("remedios.vitaminD"), horario: "12:00", tomado: false },
    { id: 3, nome: t("remedios.calcium"), horario: "20:00", tomado: false },
  ];
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <div className="container max-w-xl mx-auto px-4 space-y-6">
        <PageHeader title={t("remedios.title")} emoji="💊" />

        <GuideCharacter
          message={allDone ? t("remedios.allTaken") : t("remedios.reminder")}
          size="sm"
        />

        {/* Form to add medicine */}
        <div className="card-elder space-y-4">
          <h3 className="text-lg font-semibold text-foreground">{t("remedios.addNew")}</h3>
          <div className="space-y-2">
            <input
              type="text"
              placeholder={t("remedios.medicineName")}
              value={newNome}
